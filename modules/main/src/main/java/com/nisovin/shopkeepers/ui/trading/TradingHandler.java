...
public class TradingHandler extends AbstractShopkeeperUIHandler {
    ...
    private boolean matches(
        ...
        boolean nmsItemCompareResult1 = NMSManager.getProvider().matches(standardIt(offeredItem1), standardIt(requiredItem1.copy()));
        boolean nmsItemCompareResult2 = NMSManager.getProvider().matches(standardIt(offeredItem2), standardIt(requiredItem2.copy()));
     ...
     *
     * @param tradingContext the trading context, not <code>null</code>
     */
     ...
     *
     * @param trade the trade, not <code>null</code>
     */
     ...
     *
     * @param tradingContext the trading context, not <code>null</code>
     * @param silent         <code>true</code> to skip any actions that might be noticeable by players on the
     *                       server
     */
